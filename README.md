...
> A design system for travel-ds UI components, built on [@design-systems/cli](https://github.com/intuit/design-systems-cli).

## 👍 Philosophy

This is a design system intended for UI components currently being built or tested in travel-ds.
...
For an example we will try to use the `@travel-ds/card` component.

```sh
npm i @travel-ds/card
# or with yarn
yarn add @travel-ds/card
```
...
Now whenever you import one of the `@travel-ds` components, `babel` will automatically include the correct CSS file!
